...
(function (window, document) {
    ...
    */
    ...
    ath.intl = {
        ...
        en_us: {
            ios: 'To add this web app to the home screen: tap %icon and then <strong>Add XCRYPT App to Home Screen</strong>.',
            android: 'To add this web app to the home screen open the browser option menu and tap on <strong>Add XCRYPT App to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
        },
    ...
    ath.Class = function (options) {
        ...
        if ( !ath.isCompatible ) {
             this.doLog("Add XCRYPT App to homescreen: not displaying callout because device not supported");
            return;
        }
